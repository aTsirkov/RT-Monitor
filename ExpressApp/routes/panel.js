...
function lastPoint(req, res) {
    var connection = new Connection(config, function (err) {
        if (err)
            console.error('connection CallBack => ', err);
    });
...
exports.lastPoint = lastPoint;
function pointsList(req, res) {
    var connection = new Connection(config, function (err) {
        if (err)
            console.error('connection CallBack => ', err);
    });
...
exports.lastPointM1 = lastPointM1;
function pointsListM1(req, res) {
    var connection = new Connection(config, function (err) {
        if (err)
            console.error('connection CallBack => ', err);
    });
...
exports.pointsListM1 = pointsListM1;
